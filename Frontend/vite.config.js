...
export default defineConfig(({ mode }) => {
  // Load ALL env vars (no VITE_ prefix filter) — API_BASE_URL comes from
  // .env.local locally and from Vercel environment variables in production.
  const env = loadEnv(mode, process.cwd(), '')

  return {
    // Expose only API_BASE_URL to the client via import.meta.env
    define: {
